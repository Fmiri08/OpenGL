...
class Ground:
    def __init__(self, x, y, z, width, height):
        ...
        self.width = width
        self.height = height
        self.texture = Texture("./Images/Ground/ground.png")

        vertices = [
            -width / 2 + x, y, -height / 2 + z, 0, 0,
            width / 2 + x, y, -height / 2 + z, 0, width/20,
            width / 2 + x, y, height / 2 + z, height/20, width/20,
            -width / 2 + x, y, height / 2 + z, height/20, 0
        ]
